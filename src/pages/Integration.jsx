...
const NexusHub = () => {
  const [activeTab, setActiveTab] = useState('integration'); // Default to integration for demo
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'integration' && (
         ...
         {/* ================= MDM VIEW (Placeholder) ================= */}
         {activeTab === 'mdm' && (
           <div className="flex flex-col items-center justify-center h-96 text-slate-400 animate-fade-in">
              <Database className="w-16 h-16 mb-4 opacity-20" />
              <h2 className="text-xl font-semibold text-slate-600">Master Data Management</h2>
              <p>ส่วนจัดการข้อมูลหลัก (อยู่ระหว่างการพัฒนา)</p>
           </div>
         )}
